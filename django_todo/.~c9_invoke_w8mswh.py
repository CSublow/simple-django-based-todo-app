...
# If there is a environment variable called development, create a variable called development and set it to true
    development = True # This will tell the program it is in a dev environment. If that's the case, you don't want to use production settings, like the database url specific to 
